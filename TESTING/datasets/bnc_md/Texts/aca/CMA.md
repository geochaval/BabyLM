...
The animal which is learning does not operate like an idiot photographer [UNK] attempting to take a snap of everything.
...
The implication is that the [UNK] animal is able to classify neutral events prior to learning and has a rule for what classes are relevant to particular outcomes.
...
Another independent piece of evidence corroborating the Westermarck [UNK] hypothesis is provided by stable incestuous relationships (Weinberg, 1956).
...
Indeed, this point [UNK] has been used as a general criticism of the discrepancy hypothesis (Thomas, 1971).
...
Fig. 24.4 shows the mean percentage durations [UNK] spent in front of each category of stimulus bird by both adult males and females.
...
The results with quail provide direct support for the discrepancy hypothesis as applied to sexual preferences and indirect support for the [UNK] notion of optimal outbreeding.
...
Sometimes parallel cousins [UNK] are forbidden as spouses and cross-cousins are favoured.
...
It is a bit like arguing that if the hypothesis that smoking [UNK] causes lung cancer is to be believed, everybody who smokes must get cancer; what is more nothing else (such as asbestos) can be admitted as having the same effect.
...
- (3) Behaviour which lies outside (1) and (2), and to which in addition there may be strong personal disinclination: e.g. homosexuality as regarded in enlightened circles.
