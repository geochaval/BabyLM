...
- 3. The manufacturing labour force in developed countries is now in [UNK] accelerating decline as productivity and the investment per worker increases, this is resulting in a further increase in service industries and an increase in unemployment.
...
In dealing with lower technology or less formal system design, there is a range of relatively standard ways of finding out about operator performance [UNK] by studying it directly.
...
Gagne also separated four [UNK] phases of a learning sequence; apprehension, acquisition, storage and retrieval.
...
- 1. Behaviour at a higher skilled level is characterised by selectivity in choice of inputs and outputs and by increasing influence of the past and the future rather than the immediate situation.

- 2. Learning is an activity of an individual, no one else can do it for him.
Educators and trainers can do no more than provide the conditions, the content and the materials.

- 3. Social skills and communication generally depend on the detection and definition of mutually agreed internal models of reality.

- 4. The human memory, in common with every other store, has to be positively consulted before it will function.
...
- 6. There is a considerable art in developing the most effective combination of external and internal stores and reminders which every highly skilled person deliberately cultivates.
...
- 7. This self-organised work design has its parallel in designing tasks for others.
...
- 8. There are at least three and probably many more levels of storage.
...
- 9. There seems to be a memory for elaborate patterns and sequences which takes a long time to develop.
...
- 9. The corollary for the trainer is to look for patterns which exist in complex material and introduce the trainee to the patterns as well as to the separate facts.
...
- 10. Errors in recall can be similar for different individuals.
...
- 1. Always try to put the interviewees at ease.
...
- 4. Always structure the interview to ensure that all essential points are covered.
...
- 5. Assess the interviewee under various headings to obtain a comparable profile score.
...
- 1. Obtain all the relevant factual data (biography and testscores) before the final interview.

- 2. Provide a waiting room which has accessible toilet facilities including mirrors.

- 3. The interviewer should collect the interviewee, not have him sent for from the waiting room.

- 4. Provide the interviewee with a written job aid which indicates the name and function of the interviewer (s).

- 5. The relative positioning of the two main interactors and the direction of lighting are significant.
...
- 6. Provide the interviewee with opportunities to make points which have not been covered in questions and to ask other questions on matters important to him.
This is not mere courtesy, what the interviewee regards as important can be very revealing.

- 7. Provide clear if indirect indications that the interview is ending.

- 8. Tell the interviewee what the next stage in the process will be and when.

- 9. Escort the interviewee at least to the door, again the behaviour at the parting point can be significant.
...
[UNK] Large scale impersonal surveys can be supplemented by more personally based interviews either with individuals or groups.
...
In skill training the opposite can apply, the trainee is persuaded to be flexible [UNK] and to orient himself towards the end rather than the means.
...
- 1. The trainee must wish to learn, nothing can be achieved unless the trainee is adequately motivated.

- 2. The learning must be steered by adequate knowledge of performance.
...
To do this the trainer must have a coherent model of the form of the [UNK] skill, this is attained by skills analysis.
...
Skill is demonstrated by persistent and efficient pursuit of an objective and [UNK] the skill can usually be understood although not necessarily written down with any great precision in terms of a goal and the path towards that goal.
...
Thus, the selection process involves [UNK] describing the job first by analysis (task and skills analysis) and then the translation of these data into worker relevant terminology.
...
- 1. An inadequate reservoir of competent workers for particular tasks

- 2. A workforce sufficient in numbers or supply but not in skill level as evidenced usually by quality of work and less frequently by failures to meet production targets, danger to people and damage to equipment

- 3. Changes in technology which result in changes in required skills

- 4. An organisational commitment to continuous improvement of the skills of members

- 5. To meet statutory requirements in certain dangerous industries and services

- 6. As a service to customers buying equipment

- 7. As a service to the community paid for by public funds
...
Decisions are then needed on how to train, which will include whether or which parts should be on-line or off-line, whether the operator is required to [UNK] function in a mainly programmed (i.e. rule-following) mode and how far he may need to function in a conceptual (i.e. actions based on understanding) mode.
...
- 1. Technology provides trainer aids not trainer substitutes.
Thus computer assisted instruction (CAI) is more aptly descriptive than computer based training (CBT).

- 2. Technology enforces rigorous thinking to the point of revealing embarrassing gaps in learning, teaching and training theory.
...
- 3. It is essential to develop the basic taxonomies behind the learning situation.
...
- 4. The need for interdisciplinary approaches is reinforced but the abiding difficulties of interdisciplinary communications remain at every level from different values and concepts to different terminologies.
...
- 5. The design of the man-machine interface (MMI) or the human-computer interface (HCI) or more simply human interfaces (HI) remains one of the most difficult design problems but a crucial one in that poorly designed interfaces will wreck the performance of any system.

- 6. Evaluation is an essential procedure within the implementation of any new system.
...
- 7. Pedagogically the need to be much clearer about what is being taught and why is a mixed blessing.
