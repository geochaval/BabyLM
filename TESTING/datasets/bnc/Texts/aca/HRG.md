# Polymers: the chemistry and physics of modern materials
...
To convert this into a form which will allow us to express this in the correct site fraction form we can add and subtract [UNK] on the r.h.s. of equation (8.19) to give [UNK]
...
Thus when [UNK] then [UNK] and the osmotic pressure is given by the ideal solution law.
...
Flory and Krigbaum defined an enthalpy [UNK] parameter and an entropy of dilution [UNK] parameter such that the thermodynamic functions used to describe these long range effects are given in terms of the excess partial molar quantities [UNK] [UNK]
...
The expression for the reduced osmotic pressure [UNK] has already been derived in section 8.7 and has the form [UNK] where the limiting form, valid only at infinite dilution, is [UNK]
...
Now µ is a function of T, P and c 2 but if T is constant then [UNK] and as [UNK] where γ 2 is the activity coefficient.
...
The two quantities are related, in the absence of excluded volume effects, for simple chains by [UNK] but as the actual dimensions obtained can depend on the conditions of the measurement, other factors must also be considered.
...
- (a) the regular folded array with adjacent re-entry of the chains, but with some loose folding and emergent chain ends or cilia that contribute to the disordered surface, or

- (b) the switchboard model, where there is some folding of the chains but re-entry is now quite random.
...
[UNK] [UNK] This means that there is no significant reordering of the chain conformation when crystallization takes place after cooling from the melt, which would be required if a regularly folded chain structure was to be constructed in the lamellae.
...
A study of the fine structure of a spherulite shows that it is built up of fibrous [UNK] sub-units, growth takes place by the formation of fibrils which spread outwards from the nucleus in bundles, into the surrounding amorphous phase.
...
- (i) the rate of nucleation; and

- (ii) the subsequent rate of growth of these nuclei to macroscopic dimensions.
...
The final relation describing the process is known as the Avrami equation expressed as [UNK] where k is the rate constant, w o and w L are the masses of the melt at zero time and that left after time t.
...
Sporadic nucleation is assumed to be a first-order mechanism and if we consider that a two-dimensional disc is formed, then [UNK].
Rapid nucleation is a zeroth-order process in which the growth centres are formed at the same time, and for each growth unit listed in table 11.3, the corresponding values of the exponent would be [UNK].
...
When [UNK] the sample is completely molten the dilatometer is transferred to a second thermostat set at the temperature selected for crystallization to take place and allowed to equilibrate.
...
The mass fraction of the uncrystallized polymer [UNK] can be related to the volume changes and to the heights measured in the dilatometer by [UNK] where h t, h o, and h ∞ are the heights at time t, the beginning, and the end of the process respectively, with V t, V o, and V ∞ the corresponding volumes.
The slope of a plot of [UNK] against t allows evaluation of the Avrami exponent n while k can be calculated from the intercept.
...
Deviations from the Avrami treatment may also be observed towards the end of the crystallization process and values of h∞ are often [UNK] difficult to determine accurately, as shown in the curve derived from dilatometric data.
...
The relaxation modulus E r was measured at a standard time interval of 10 s and [UNK], is shown as a function of temperature in figure 12.1.
Five distinct regions can be identified on this curve.

- (i) The glassy state.
This is section A to B lying below 363 K and it is characterized by a modulus between 10 9.5; and [UNK].
...
- (ii) Leathery or retarded highly elastic state.
This is the transition region B to C where the modulus drops sharply from about 10 9 to about [UNK] over the temperature range 363 to 393 K. The glass transition temperature T g is located in this area and the rapid change in modulus reflects the constant increase in molecular motion as the temperature rises from T g to about [UNK].
...
- (iii) The rubbery state.
At approximately 30 K above the glass transition the modulus curve begins to flatten out into the plateau region C to D in the modulus interval 10 5.7; to [UNK] and extends up to about 420 K.

- (iv) Rubbery flow.
After the rubbery plateau the modulus again decreases from 10 5.4 to [UNK] in the section D to E. The effect of applied stress to a polymer in states (iii) and (iv) is shown in figure 12.1 (c) where there is instantaneous elastic response followed by a region of flow.
...
Here there is a steady decrease of the modulus from [UNK] as the temperature increases.
...
A liquid, forced to flow in this way by a shearing force σ, experiences a viscous resistance expressed by [UNK] where v is the velocity of flow along a tube of radius x, so that [UNK] is the velocity gradient or shear rate γ, and η is the viscosity coefficient of the liquid.
A liquid is said to exhibit Newtonian flow if η is independent of γ but substances which show deviations from this flow pattern, with either decreasing or increasing [UNK] ratios, are termed non-Newtonian.
(See figure 12.2.)
Most polymers fall into this latter category, with η decreasing as the shear rate increases.

The temperature dependence of η can normally be expressed in the form [UNK] [UNK] [UNK] where A is a constant and ΔE D represents the activation energy required to create a hole big enough for a molecule to translate or 'jump' into during flow.
...
Above c the relation describing the flow behaviour is [UNK] and K 1 is proportional to the 3.4 power of.
Below c, η is directly proportional to and the expression becomes [UNK] where K 1 and K 2 are temperature dependent constants.
...
Mechanistically it can be regarded as the movement of a kink in the chain along its length (see figure 12.5) until this reaches the end of the [UNK] chain and leaves it.
...
If the tube is defined as having the same length as the unperturbed chain, nl o, where l o is the bond length under θ conditions (corrected for short range interactions), then the time required for the chain to reptate out of the tube is proportional to the square of the distance travelled, i.e. [UNK]
...
This can be expressed as the frictional coefficient for the chain, again within the tube confines [UNK].
...
Typically τ o is of the order of 10 -10 seconds for [UNK] and so the relaxation time for a polymer chain with [UNK] would be about 100 seconds.
...
It has been shown that for a chain moving in the melt, over time-scales that greatly exceed the lifetime of the tube τ, a reptation self-diffusion coefficient D rept, can be measured which is inversely proportional to n 2, i.e. the diffusion law is [UNK]
...
The strength of the junction formed will depend on t which should be [UNK] smaller than the reptation time τ, i.e. the mixed layer ought to be smaller than the size of the coil if an interfacial link is to be formed.
...
It has been found that if a block of poly (vinylchloride) is brought in contact with a block of polycaprolactone, at temperatures above T g, then D rept is higher than expected and is proportional to [UNK].
...
If it is still stable at temperatures in excess of 100 K above T g, the temperature dependence has an exponential form [UNK] where according to the Eyring rate theory ΔH is the activation enthalpy of viscous flow and is a more representative parameter than the energy.
...
The viscosity increases rapidly to a value of about [UNK] as T g is approached, but on passing from the melt to the glass a region of rubbery flow and elasticity is traversed.
...
This produces a distribution of chain conformations which differs significantly from the most probable distribution, and as this is an unstable state the chains will rapidly recoil when the [UNK] stress is released in an attempt to regain their original shape distribution.
...
- (2) molecular structure (steric effects),

- (3) molar mass (see section 12.12),

- (4) branching and crosslinking
...
Flexibility is obtained when the chains are made up of bond sequences which are able to rotate easily, and polymers containing [UNK],, or [UNK] links will have correspondingly low values of T g.
...
The p-phenylene ring is particularly effective in this respect, but when carried to extremes, produces a highly intractable, rigid structure, poly (p-phenylene) [UNK] with no softening point.
...
When the polymer chains are unsymmetrical, with repeat units of the type [UNK], an additional restriction to rotation is imposed by steric effects.
...
From the examination of a wide range of polymers they concluded that [UNK] where K 1 is a constant with a value of 0.113.
...
The [UNK] definition of the S-B free volume can be seen from figure 12.10 to be [UNK] where V o ι is the hypothetical liquid volume at absolute zero.
This definition is perhaps too rigid and discounts differing chain flexibilities, so a more accurate representation is thought to be given by [UNK]
...
In section 12.7 the Arrhenius equation was used to describe the temperature dependence of viscous flow, but an empirical equation proposed by Doolittle gives a much better description of viscous flow, and has a similar form [UNK] where A and B are constants and [UNK].
On a molecular level, the ratio [UNK] is then a measure of the average volume of the polymer relative to that of the holes.
Thus when [UNK], i.e. the polymer chain is larger than the average hole size, the viscosity will be correspondingly high, whereas when [UNK], the viscosity will be low.
We can now introduce a free volume fraction f [UNK] and substitute in equation (12.13)

Next, a comparison can be made between the viscosity of a polymer melt at a temperature [UNK], and that at a reference temperature such as and so [UNK]
...
If α f is the expansion coefficient of the free volume above T g, then the temperature dependence of f τ can be written [UNK] Substitution of equation (12.17) in equation (12.16) gives [UNK] [UNK] [UNK] Rearranging and dividing by α f [UNK]

Equation (12.19) is one form of the WLF equation, but as viscosity is a time dependent quantity and is proportional to the flow time, t, and density, ρ, then [UNK] and [UNK] where the small differences in density have been neglected.
This can be compared with the form of the WLF equation [UNK] where ατ is the reduced variables shift factor, C 1 and C 2 are constants that can be evaluated from experimental data, and are found to be [UNK] and [UNK] when T g is the reference temperature.
A more general description can be used [UNK] where T s is an arbitrary reference temperature usually located [UNK] 50 K above T g.
...
The modulus will be much less temperature dependent than the viscosity so we can write [UNK] which demonstrates the equivalence of the empirical equation (12.22) with that derived from the free volume theory, equations (12.19) and 12.21).
...
The equations (12.19) and (12.22) can be used to evaluate f g as we see that [UNK] and [UNK].
On the basis of viscosity data, B can be assigned a value of unity, leading to [UNK] and [UNK].
If α f is assumed to be equivalent to [UNK], this value compares well with the average value of [UNK] determined for 18 polymers covering a wide range of T g.
...
The flex energy is the energy difference between the potential energy minimum of the located bond and the potential minima of the remaining [UNK] possible orientations which may be used on the lattice.
...
This leads to [UNK] where [UNK] and [UNK]
...
- (a) that a chain of zero stiffness would have a T g of 0 K and

- (b) that the T g would be essentially independent of any intermolecular interactions
...
The transition probability of such a co-operative region is then calculated as a function of its size, to be [UNK] where Δµ is the activation energy for a co-operative rearrangement per monomer segment.
A lower limit to Ζ is then defined; this is the smallest size Ζ*; capable of having two configurations available to it, with a critical configurational entropy [UNK] which, from the definition, can be approximated by [UNK].
Thus [UNK] where S c is the macroscopic configurational entropy for the ensemble.
Substitution gives [UNK] and expressing this in the WLF form [UNK] [UNK]

The following approximations for S c can now be used [UNK] and, remembering that [UNK], then [UNK] Substitution in equation (12.29b) gives a WLF equation [UNK] where [UNK] [UNK]
...
The Adam-Gibbs equations also lead to a value of [UNK], so the theory appears to resolve most of the differences between the kinetic and thermodynamic interpretations of the glass transition.
...
Bueche expressed this as [UNK] where [UNK] is the glass temperature of a polymer with a very large molar mass, θ is the free volume contribution of one chain end and is 2θ for a linear polymer, ρ is the polymer density, N A is Avogradro's constant, and α f is the free volume expansivity defined as [UNK] The linear expression in equation (12.33) has been widely used and describes the [UNK] behaviour of many polymer systems over a reasonable range of molar mass (> 5000).
...
Region I denotes the range of chain lengths at which T g reaches its asymptotic value [UNK] and the critical value x c at which this occurs increases as the chain becomes more rigid.
...
The relationship between [UNK] and x c is then [UNK]
...
While the co-operative, long-range, chain motion which is released on passing from the glass to the rubber-like state is not possible at [UNK], other relaxations can take place.
...
Rotation of the oxycarbonyl group about [UNK] has been identified as the cause.
...
When R is larger,, another relaxation process is seen at around 120 K, which is common to all of these polymers with [UNK].
...
This point still requires confirmation as a general phenomenon, but [UNK] there is little doubt that polymer molecules are not totally frozen or immobile when in the glassy state and that small sub units in the chain can remain mechanically and dielectrically active below T g.
...
- (iii) uniform compression.

#### Simple tension.

Consider a parallelepiped of length x o and cross-sectional area [UNK] [UNK].
If this is subjected to a balanced pair of tensile forces F, its length changes by an increment dx so that [UNK].
When dx is small, Hooke's law is obeyed, and the tensile stress σ is proportional to the tensile strain Ε.
The constant of proportionality is known as the modulus, and for elastic solids [UNK] where E is Young's modulus

The stress σ is a measure of the force per unit area [UNK], and the strain or elongation is defined as the extension per unit length, i.e. [UNK].
It should be pointed out, however, that other definitions of strain will be met with in the literature, most notably, is often called the true strain, while an expression arising from the kinetic theory of elasticity has the form [UNK]
...
If the base of the body, shown shaded in the diagram, figure 13.1 (b) is firmly [UNK] fixed, a transverse force F applied to the opposite face is sufficient to cause a deformation dx through an angle θ.
The shear modulus C is then given by the quotient of the shearing force per unit area and the shear per unit distance between shearing surfaces; and so [UNK] For very small shearing strains tan θ [UNK] θ and [UNK]
...
When a hydrostatic pressure - p is applied to a body of volume V o, causing a change in volume ΔV, a bulk modulus B can be defined as [UNK]

The quantity B is often expressed in terms of the compressibility which is the reciprocal of the bulk modulus.
Similarly [UNK] and [UNK] are known as the tensile and shear compliances and given the symbols D and J respectively.
...
The various moduli can be related to each other in a simple manner, because an isotropic body is considered to possess only two independent elastic constants and so [UNK]
...
[UNK] The response of polymers to mechanical stresses can vary widely, and depends on the particular state the polymer is in at any given temperature.
...
The application of a shear stress to a viscous liquid on the other hand, is relieved by viscous flow, and for small values of σ s can be described by Newton's law [UNK] where η is the coefficient of viscosity and [UNK] is the rate of shear sometimes denoted by γ.
...
This assumes that both contributions to the strain are additive so that [UNK].
Expressing this as the differential equation leads to the equation of motion of a Maxwell unit [UNK]

Under conditions of constant shear strain [UNK] the relation becomes [UNK] and if the boundary condition is assumed that [UNK] at zero time, the solution to this equation is [UNK] where σ o is the initial stress immediately after stretching the polymer.
...
At a time [UNK] the stress is reduced to [UNK] times the original value and this characteristic time is known as the relaxation time τ.
...
Under conditions of constant stress, a [UNK] Maxwell body shows instantaneous elastic deformation first, followed by a viscous flow.
...
The corresponding expression for strain is [UNK]

Here [UNK] is known as the retardation time and is a measure of the time delay in the strain after imposition of the stress.
For high values of the viscosity, the retardation time is long and this represents the length of time the model takes to attain [UNK] or 0.632 of the equilibrium elongation.
...
- (1) Creep, where there is a delayed strain response after the rapid application of a stress,

- (2) Stress-relaxation (section 13.7) in which the material is quickly subjected to a strain and a subsequent decay of stress is observed, and

- (3) Dynamic response (section 13.9) of a body to the imposition of a steady sinusoidal stress.
...
This rapid response is followed by a region of creep, A to B, initially fast but eventually slowing down to a constant rate represented by the section B to C. When the stress is removed the instantaneous elastic response OA is completely recovered and the curve drops from C to D, i.e. the distance [UNK].
There follows a slower recovery in the region D to E which is never complete, falling short of the initial state by an increment [UNK].
This is a measure of the viscous flow experienced by the sample and is a completely non-recoverable response.
If the tensile load is enlarged, both the elongation and the creep rate increase, so results are usually reported in terms of the creep compliance J (t), defined as the ratio of the relative elongation y at [UNK] time t to the stress so that
...
In diagram (ii), representing zero time, the spring E 1 extends by an amount [UNK].
...
Such behaviour is described by [UNK] where the retardation time τ R provides a measure of the time required for E 2 and η 2 to reach 0.632 of their total deformation.
...
As no force acts on η 3 it remains in the extended state, and corresponds to the non-recoverable viscous flow; region [UNK].
The system is then as shown in diagram (v).
In practice, a substance possesses a large number of retardation times which can be expressed as a distribution [UNK] function [UNK] where [UNK]

To the first approximation, this is estimated from a plot of creep compliance against [UNK], and [UNK] is the contribution from viscous flow.
...
Thus if the stress alters continually, the summation can be [UNK] replaced by an integral, and σ n by a continually varying function, so that at time t * when the stress [UNK] existed, the strain is given by [UNK]
...
The results are expressed as a relaxation modulus [UNK] which is a function of the time of observation.
Typical data for polyisobutylene are shown in section 13.14, figure 13.21, where the logarithm of the relaxation modulus log [UNK] is plotted against log t.
From the curves it can be seen that there is a rapid change in log [UNK] over a narrow range of temperature corresponding to the glass transition.

Again a simple model with a single relaxation time is too crude, and the stress relaxation modulus [UNK] is better represented by [UNK] where [UNK] is the distribution function of relaxation times.
...
The resulting strain can be described in the terms of its angular frequency ο and the maximum amplitude Ε o using complex notation, by [UNK] where [UNK], the frequency is v and [UNK].
The relation between the alternating [UNK] stress and strain is written as [UNK] where [UNK] is the frequency dependent complex dynamic modulus defined by [UNK]

This shows that [UNK] is composed of two frequency dependent components; is the real part in phase with the strain called the storage modulus, and [UNK] is the loss modulus defined as the ratio of the component 90° out of phase with the stress to the stress itself.
Hence [UNK] measures the amount of stored energy and [UNK], sometimes called the imaginary part, is actually a real quantity measuring the amount of energy dissipated by the material.

The response is often expressed as a complex dynamic compliance [UNK] especially if a generalized Voigt model is used.
For a Maxwell model [UNK]
...
This is a measure of the internal friction and is related to the complex moduli by [UNK]

The onset of molecular motion in a polymer sample is reflected in the behaviour of E′ and E′′.
A schematic diagram (figure 13.11) of the variation of E′ and E′′ as a function of ο, assuming only a single value for τ in the model, shows that a maximum in the loss angle is observed where [UNK].
This represents a transition point such as T g, T m or [UNK] some other region where significant molecular motion occurs in the sample.
...
- (b) forced vibration - resonance,

- (c) forced vibration - non-resonance
...
The exponential decay of the amplitude along the axis provides an indication of the mechanical [UNK] damping.
At a temperature [UNK] the sample absorbs most of the energy and damping is high whereas at a much lower temperature [UNK] the material tends to store the energy and mechanical damping is considerably lower.
...
It is calculated from the ratio of amplitudes of any two successive oscillations using the relation [UNK]

The shear modulus can also be derived from the data, being inversely proportional to the square of the period [UNK], where K is a factor depending on the shape and the size of the sample and I is the polar moment of inertia.
...
The results provide information on the elastic modulus E since it is related to the square of the resonance frequency by [UNK] [UNK] where c is a numerical constant, L is the free length of the sample, D is its thickness, and ρ is the sample density.

If the amplitudes are expressed as ratios of the amplitude to the maximum amplitude, then damping is measured from the half-width h of the curve, i.e. [UNK]
...
A sinusoidal tensile stress of a given frequency can be generated in the vibrator A and if the electrical vectors from the force and displacement are represented by [UNK] and [UNK] then by satisfying the condition [UNK] the tangent of the phase angle δ between the stress and the strain may be calculated from [UNK] [UNK] This operation of adjustment followed by subtraction of the electrical vectors is performed directly in the recording circuit.

The complex elastic modulus E * is given by [UNK] where F is the amplitude of the tensile force, A is the sample cross-sectional area, L is the sample length, and ΔL is the amplitude of elongation.
Tensile storage and loss moduli E′ and E′′ follow from [UNK] and [UNK].
...
In the bending mode the sample, in the form of a small bar, is clamped firmly at both [UNK] ends and the central point is vibrated by means of a ceramic drive shaft.
...
In general, one can select a dissipation factor or loss tangent derived from the ratio [UNK] or [UNK] to represent the energy conversion per cycle.
This leads to the equivalent forms [UNK] [UNK] and [UNK]

To a first approximation it is also possible to write [UNK] thereby allowing use of the data from either type of measurement to characterize the sample.
It should also be noted that if complex moduli are used the corresponding complex compliances are given by [UNK].
Moduli can also be related to the viscosity, and [UNK] where η is known as the dynamic viscosity.

The approximations [UNK] and [UNK] can be made when damping is low, and the absolute value for the modulus |G| or |E| can be related to the complex components by [UNK].
...
In DETA a small alternating electric field is applied to the sample and the electric charge displacement Q is measured by following the current [UNK].
The complex dielectric permittivity ε * can be measured from the change in amplitude and, if the phase lag between the applied voltage and the outcoming current is determined (see figure 13.16), then ε * can be resolved into the two components ε′, the storage (dielectric [UNK] constant) and ε′′, the loss (dielectric loss).
...
The magnitude of this decrease [UNK] is a measure of the strength of the molecular dipole involved in the relaxation, where ε o is the static dielectric constant related to the actual dipole moment of the polymer and ε∞ is the dielectric constant measured at high frequencies.
When the dielectric loss factor is measured at a characteristic frequency ο max and a given temperature, it passes through a maximum when a relaxation occurs, and the dipole [UNK] relaxation time [UNK], can be obtained.
...
Dielectric relaxation processes can be described formally by the following relations: and [UNK]

A useful way of examining the data is to measure the ratio of the two factors, which gives the dielectric loss tangent [UNK]
...
Formally, the dielectric constant [UNK] can be regarded as the equivalent of the mechanical compliance [UNK], rather than the modulus, and this highlights the fact that mechanical techniques measure the ability of the system to resist movement, whereas the dielectric approach is a measurement of the ability of the system to move, given that the groups involved must also be dipolar.
Interestingly, the dielectric loss [UNK] appears to match the loss modulus [UNK] more closely than the loss compliance when data are compared for the same system.
...
The maximum of this loss peak [UNK] is seen to move from a [UNK] temperature of about 360 K (0.01 Hz) to about 400 K (100 kHz), which is an increase of 40 K over a frequency change of seven orders of magnitude.
This is close to the rule of thumb that the temperature for the maximum of a loss peak [UNK] (or a relaxation process) will change by approximately 7 K for each decade of change in frequency.

This type of measurement can be used to estimate the activation energy [UNK] for a transition or relaxation process, if the frequency v, at T max is expressed as a function of reciprocal temperature according to the relation [UNK]
...
From the spectra it can be seen that the intensity of the β-peak relative to the α-peak is much stronger in the dielectric response compared with [UNK] the mechanical measurements.
...
An arbitrary temperature T o is first chosen to serve as a reference which in the present case [UNK] is 298 K. As values of the relaxation modulus [UNK] have been measured at widely differing temperatures, they must be corrected for changes in the sample density with temperature to give a reduced modulus, where ρ and ρ o are the polymer densities at T and T o respectively.
...
The curve obtained at each temperature is shifted by an amount [UNK]
...
Curves exhibiting the creep behaviour of polymers at different temperatures can be compared by plotting [UNK] against log t.
...
This shift factor has also been defined as the ratio of relaxation or retardation times at the temperatures T and T o i.e. [UNK] and is related to the viscosities.
If the viscosities obey the Arrhenius equation, then by neglecting the correction factor, we can express a τ in an exponential form as [UNK] or [UNK] where b is a constant.

This equation is very similar in form to the WLF equation,

For polyisobutylene, the shift factor a τ can be predicted if [UNK] is used with [UNK] and [UNK].
As outlined in chapter 12, the reference temperature is often chosen to be T g with [UNK] and [UNK], from which a τ can be calculated for various amorphous polymers.
...
An example of the latter type of shift is shown in [UNK] figure 13.22, where instead of time dependence measurements the frequency dependence of the β-relaxation in poly (vinyl acetate) has been studied at fixed temperatures in the range 212 to 266 K. A master curve can be constructed for this relaxation region by plotting [UNK] against [UNK], where the 'max' subscript refers to the peak maximum at each experimental temperature.
...
The second mode p = 2 corresponds to the movement of the chain ends in opposite directions; for p = 3, both chain ends move in the same [UNK] direction, but the centre moves in the opposite direction.
...
Using this concept, Rouse considered a molecule in dilute solution under sinusoidal shear and derived the relations [UNK] [UNK] [UNK] where η and η s are the viscosities of the solution and the solvent respectively, n is the number of molecules per unit volume, k is the Boltzmann constant, and ο is the angular frequency of the applied stress which is zero for steady flow.
...
The continuous relaxation and retardation spectra calculated from the Rouse theory are [UNK] and [UNK] where [UNK] is the unperturbed mean square end-to-end distance of a chain of molar mass M and density ρ containing N monomer units.
The equations predict linearity in the plots [UNK] and [UNK] against [UNK] with slopes of-½ and +½ respectively.
