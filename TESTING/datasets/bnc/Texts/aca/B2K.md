...
It may now be pointed out that, with the restriction (9.14), the above solution includes the Khan-Penrose (1971) solution for colliding impulsive waves when [UNK].
...
It may be noted that the Legendre functions of the second kind [UNK] are all singular when [UNK].
...
It can also be shown using (10.6) that the wave front of the approaching wave in region II behaves as [UNK] (10.36) Thus, unless [UNK], the wave front may have a distributional amplitude.
...
With this, the line element (10.49) takes the form [UNK] (10.51) which may immediately be recognized as the Schwarzschild metric with [UNK].,
...
It is appropriate at this point to consider the alternative system of coordinates defined by [UNK].
...
It may also be noted that the solutions given in the notation of previous sections by [UNK] (10.69) where c 1 and c 2 are given by (10.67), similarly do not contain curvature singularities on the hypersurface [UNK] provided the constants d i and a are constrained by (10.66) and (10.68).
...
Finally, there are the separable solutions of (10.73) which are non-singular on the initial boundaries, namely [UNK] (10.82) which again involve Legendre functions of the first and second kind.
...
Using the above notation, the non-zero components of the Weyl tensor given by (6.23) can be written as [UNK] (11 10)
...
In terms of the functions f and g, the conditions (11.22) become [UNK] where k 1 and k 2 must satisfy the inequalities (7.13).
...
The above transformation is also related to the well known result that, if Z is a solution of Ernst's equation (11.8), then another solution is given by [UNK] (12.16) where b is a real constant.
...
With this definition and (12.34), the equations (12.32) and (12.35) can now be rewritten in the form [UNK] (12.37) and [UNK] (12.38)
...
In terms of the metric functions of the Szekeres line element (6.20), the original solution is described by the three functions U, V and M which are each functions of f and g where, as in (7.8), it is convenient to put [UNK] (12.47) and, as in (12.4), (12.48)
...
As in the degenerate Ferrari-Ibañez solution, the singularity structure is thus complicated by the fact that the solution contains impulsive waves on the wave fronts [UNK] and [UNK] which form the boundaries of the interaction region.
...
When [UNK], this reduces to the Nutku-Halil solution.
With [UNK], one obtains the Kerr-NUT solution with α being the NUT parameter.
The subcase with [UNK] and [UNK] becomes the Schwarzschild-NUT space-time.

Transforming (13.37) using the Neugebauer Kramer involution produces another three-parameter family of solutions with the alternative Ernst function given by [UNK] (13.38) With [UNK], this reduces to the Chandrasekhar-Xanthopoulos solution.

Ernst, García-Díaz and Hauser (1987 b) have also found a simpler realization [UNK] of the Geroch group of transformations relating colliding wave solutions.
With this, they have obtained a generalization of the above solution in the case when [UNK].
A further generalization of the [UNK] solution is also obtained using a Neugebauer-Kramer involution.
...
It has also been demonstrated that the metric in the interaction region IV may be taken in the form of the Szekeres line element (6.20) which involves the four functions [UNK],, and [UNK] satisfying equations (6.22).
One of these equations can be integrated to give [UNK].
(14.1)

In this approach, it is assumed that the initial conditions are determined by the functions [UNK] and [UNK] which represents the wave in region II as it reaches the boundary [UNK], and by [UNK] which represents the wave in region III as it reaches the boundary [UNK].
This is now a typical case of the characteristic initial-value problem.

In practice, however, things are a little more complicated since it is normal to make use of the transformation (6.7) to put [UNK] in these initial regions.
...
Accordingly, it is therefore more convenient to use the transformation (6.7) in the initial regions to put [UNK] (14.2) where the constants [UNK] and [UNK] are essential in order to retain the continuity properties of the functions f and g across the boundaries [UNK] and [UNK].
...
In this case, the data specifying the initial waves is now given by [UNK] on [UNK], and by [UNK] on [UNK].
In addition, since the function M is essentially determined up to a removable constant for any V and W by equations (6.22b, c), the initial data is effectively described by specifying only the metric functions V and W on the boundaries [UNK] and [UNK].
...
For the case when the approaching waves have aligned linear polarization it is possible to put [UNK] everywhere, and the main field equation for V may be expressed in terms of different coordinates in any of the forms (9.3), (10.2), (10.11), (10.60) or (10.71).
At this point we may take f and g as coordinates and consider the equation in the form (10.2) which may be rewritten as [UNK].
(14.3) This equation must now be solved for [UNK] with initial data defining the approaching waves given by [UNK] and [UNK].
It is also possible to scale the approaching waves such that at the point of collision [UNK], and [UNK].
...
According to this method, we consider the adjoint equation [UNK] (14,4) where R is a Riemann-Green function satisfying the boundary conditions [UNK].
(14.5)

Figure 14.1 The interaction region IV is represented in f, g coordinates by the region inside the triangle shown.
The sides [UNK] and [UNK] are the II-IV and III-IV boundaries respectively, and the focusing singularity occurs on the line [UNK].
The solution for [UNK] may be obtained at any point P by integrating round the rectangle PNML.

By using Green's theorem the integral of [UNK] over the rectangle PNML indicated in Figure 14.1 can be related to its line integral around the boundary.
In this way it can be shown that, for any arbitrary point [UNK] within the interaction region, the function V is given by [UNK] (14.6) provided that R satisfies (14.4) and (14.5) and that [UNK].

A specific Riemann Green function which satisfies (14.4) and (14.5) is given by [UNK] (14.7) where [UNK] is the Legendre function of order -½.
...
In fact their approach is based on the solution (10.8), which may be re-expressed in the form [UNK] (14.8) for suitable functions [UNK] and [UNK] which must depend on the initial data.

An interesting feature of the method is that the functions [UNK] and [UNK] are obtained in terms of the prescribed initial data by solving generalized versions of Abel's integral equation for the tautochrone problem of classical particle mechanics.
Generalized versions of Abel's integral equation are required because f' (u) and g' (v) are zero on the boundaries [UNK] and [UNK] respectively.
...
For the non-colinear case, Hauser and Ernst have found it convenient to work with the complex function Z defined by (11.5) and to use the transformation (12.20) which consists of a rotation and rescaling to put [UNK] at the point of collision when [UNK] and [UNK].
...
In regions I and II, this takes the form [UNK] (15.1) and the step wave is given by [UNK].
The opposing wave with [UNK] may be described in an identical way with the null coordinate u replaced by v, and a different space-like coordinate replacing r.

The two electromagnetic field components in the initial regions I, II and III are taken to be [UNK].
...
Accordingly, the line elements in the initial regions may be taken in the forms of (4.19) and (4.20), namely [UNK] (15.3) The initial-value problem is now well set, and it remains to find the unique solution in the interaction region.
...
As usual, it may be noted that (6.22a) can immediately be integrated to give [UNK] (15 4) where f and g are arbitrary decreasing functions in the interaction region.
From the junction conditions it can be seen that, in this case, these functions necessarily take the forms:.
(15.5) The solution of the complete set of equations (6.21,22) given by Bell and Szekeres is [UNK].
(15.6)

It can be seen that these functions satisfy the required O'Brien-Synge boundary conditions.
Thus the line element in the interaction region IV is [UNK].
(15.7)
...
The coordinate transformation [UNK] (15.8) transforms the line element (15.7) into the more familiar form [UNK].
(15 9)

Halilsoy (1987) has considered an application of the transformation [UNK] to the above solution.
...
This follows from the fact that [UNK] is real, and [UNK].
...
These manifest themselves as the impulsive gravitational waves [UNK] (15.10) which may be considered to be generated by the collision.
...
In the interaction region, and [UNK] are necessarily both non-zero.
It follows that V and W can not both remain constant.
Thus, the congruences tangent to both waves must begin to shear, and it can be seen from (6.23) that the components of the Weyl tensor [UNK] and [UNK], and possibly [UNK] will necessarily appear.
...
It may also be observed from (15.10) that difficulties occur at the points [UNK].
...
They have confirmed that, in regions II and III, the surfaces on which [UNK] and [UNK] respectively behave as 'fold' singularities similar to those of the Khan-Penrose solution described in Section 8.2.
...
In this case, the surface on which [UNK], which is here given by [UNK], turns out to be merely a coordinate singularity since the curvature tensor is clearly bounded.
Bell and Szekeres have demonstrated how this singularity can be removed by considering the following coordinate transformation: (15.11) where [UNK].
With this, the line element (15.6) becomes [UNK] (15.12) which is clearly regular when [UNK].

In order to retain the one-to-one correspondence, it is appropriate initially to restrict the Bell-Szekeres coordinate x to the range [UNK].
The coordinates X and Y are restricted by [UNK], where the boundary [UNK] contains the space-like plane on which the collision occurs.

It has been shown by Clarke and Hayward (1989) that region IV is part of a space-time that is regular apart from two covering-space singularities that occur when [UNK].
These are points on the boundary of region IV where it joins with the limits of regions II and III.
At these points, which are on the polar axis [UNK] and [UNK] in the Bertotti-Robinson form of the metric (15.9),.

With the above transformation, each interval of the coordinate x of length 2 π/; c corresponds to a circular region in the X, Y plane with the origin removed and cut along the line [UNK].
...
It is also sometimes convenient (Clarke and Hayward, 1989) to make the further coordinate transformation [UNK] (15.13) With this, the line element (15.12) takes the alternative form of the Bertotti-Robinson line element [UNK] (15.14) Region IV is now described by the line element (15.14) with the coordinate ranges given by [UNK] (15.15) This is joined to regions II and III across the surfaces [UNK].
(15.16)

Clarke and Hayward (1989) have also shown that the Bell-Szekeres solution is extendable to the future through the surface [UNK], but the extension is not unique because of the presence of the singularities.
...
For the approaching wave in region II which propagates along the null line [UNK],, they have shown that v -independent perturbations are not permitted to all orders, while all the v -dependent perturbations exhibit strong divergences along the 'fold' singularity.
...
In the Bell-Szekeres solution, it has been shown that the hypersurface [UNK] on which the opposing waves mutually focus each other is a Cauchy horizon rather than a curvature singularity.
...
This is achieved by extending the coordinate range to [UNK] (15.17) where [UNK].
In this extension, the waves cross and focus.
The subsequent space-time is unchanging.

Another equally natural extension of region IV is obtained by noting that the line element (15.14) admits a reflection symmetry [UNK] about the hyperplane [UNK] (or [UNK] about [UNK]).
Thus, there is an extension in which region IV is extended as far as [UNK] and is then followed by the time reverse of the entire solution.
...
In all these solutions the space-time can only be extended uniquely up to the fold singularities in regions II and III and the surface in region IV on which [UNK].
...
Regions marked II and III contain electromagnetic waves with [UNK], and [UNK] respectively, having metrics given by (15.3).
...
Thus, to extend the Bell-Szekeres solution, the same initial conditions are given except that the component [UNK] becomes complex and, from (6.22e), W must become non-zero in the interaction region.

A solution presented by Griffiths (1985) satisfying this condition may be written in the form [UNK] (15.18) where [UNK] (15.19) The relative polarization angle of the two waves prior to the collision is given by α.
It may be noticed that the expression for U here is equivalent to those of (15.4,5) and (15.6).
The common multiple 2 has been inserted so that this solution can be more directly related to the Bell-Szekeres solution to which it reduces when [UNK].
...
In fact it can be obtained from the Bell-Szekeres line element (15.7) by the simple rotation [UNK] (15.21)
